                ...
                if btn1.win == 1 and 23 < pygame.mouse.get_pos()[0] < 583 and 120 < pygame.mouse.get_pos()[
                    ...
                    if massive_kletki[(pygame.mouse.get_pos()[1] - 120) // 35][
                        ...
                        if state == 0:  # если кнопка обычная
                            gr_kletka.add(
                                Kletka((coord[1] * 35 + 23, coord[0] * 35 + 120), "flag.png", 1))  # ставим флаг
                            count_bombs -= 1  # убовляем счётчик бомб
                        elif state == 1:  # если кнопка с флагом
                            gr_kletka.add(
                                Kletka((coord[1] * 35 + 23, coord[0] * 35 + 120), "quest.png", 2))  # ставим вопрос
                            count_bombs += 1  # прибавляем кол-во бомб
                        elif state == 2:  # если кнопка с вопросом
                            gr_kletka.add(Kletka((coord[1] * 35 + 23, coord[0] * 35 + 120), "kletka1.png",
